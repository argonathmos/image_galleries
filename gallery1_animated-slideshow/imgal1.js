...
function imgSlideStart(){
    ...
    // So we wait 2100ms before resetting hte attributes of the pictures
    setTimeout(() => { 
        ...
        if( index < 7 ){
                ...
                console.log('new index for entering img');
                index += 1;
        }else{
            console.log(index);
            leavingImg.setAttribute('src','pics/' + Number(index) + '.jpg');
        ...
        // we need to shift the pictures (.leave-left and .enter-right) back to their original position
